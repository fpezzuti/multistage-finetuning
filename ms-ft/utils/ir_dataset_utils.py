# This file was copied from https://github.com/webis-de/set-encoder
# Original author: Webis Group
...
def __check_registration_was_successful(ir_dataset_id: str) -> None:
    import ir_datasets
